export default {
  title: "How It Works",
  subtitle: "Your Journey to Finding the Perfect Match",
  process: {
    title: "Simple Process",
    subtitle: "We make the au pair program straightforward and easy",
  },
  steps: {
    profile: {
      title: "Create Profile",
      description: "First step is to create your detailed profile",
      items: [
    ...
    search: {
      ...
      description: "Browse and find potential matches",
      items: [
    ...
    connect: {
      ...
      description: "Interact with potential matches",
      items: [
        "Send messages",
    ...
    match: {
      title: "Confirm Match",
      description: "Confirm your match when you find the right one",
      items: [
        "Reach agreement",
        "Finalize details",
        "Sign contract",
    ...
    begin: {
      title: "Begin Journey",
      description: "Prepare to start your au pair journey",
      items: [
        "Process visa",
        "Arrange travel",
        "Prepare documents",
  ...
  "for-families": {
    ...
    benefits: {
      ...
      item1: "Flexible childcare support",
  ...
  "for-au-pairs": {
    ...
    benefits: {
      title: "Au Pair Benefits",
      item1: "Free accommodation & meals",
  ...
  support: {
    title: "Full Support",
    description: "We provide comprehensive support services",
    items: [
      {
        title: "Visa Support",
  ...
  faq: {
    ...
    description: "Learn more about the au pair program",
    questions: {
      q1: {
