        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-6 max-w-3xl mx-auto">
              Bringing families and au pairs together for meaningful cultural
              exchanges since 2025.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Mary AuPair was founded with a simple mission: to create
              ...
              <p className="text-gray-600 mb-4">
                Our founder, Mary Hsu, experienced firsthand the transformative
              ...
              <p className="text-gray-600">
                Today, Mary AuPair has helped thousands of families find the
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-600 italic mb-4">
                "Mary AuPair made it so easy to find the perfect au pair for our
                family. The matching process was thorough, and we found someone
                who fits perfectly with our family dynamic."
              </p>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-600 italic mb-4">
                "Being an au pair through Mary AuPair has been an incredible
                experience. I've improved my language skills, made lifelong
                friends, and gained valuable childcare experience."
              </p>
              <div className="flex items-center">
                <img
                  className="h-12 w-12 rounded-full object-cover"
