...
import { Search, Filter, Globe, Heart, MessageCircle, Star, ChevronDown, ChevronUp } from 'lucide-react';
...
const FindAuPair = () => {
  ...
  const auPairs = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80'
    }
  ];
    ...
    <div>
      ...
      <section className="relative bg-blue-600 text-white">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: "url('https://images.unsplash.com/photo-1516627145497-ae6968895b40?ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80')",
            opacity: 0.2
          }}
        ></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Browse through our database of qualified au pairs from around the world
            </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                      ...
                      <div className="space-y-2">
                        {['China', 'Spain', 'Germany', 'Brazil', 'Japan', 'Australia'].map(country => (
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {['English', 'Spanish', 'Mandarin', 'German', 'French', 'Japanese', 'Portuguese'].map(language => (
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div>
                          <label className="block text-sm font-medium text-gray-700">Min Age: {ageRange[0]}</label>
                          <input
                            type="range"
                            min="18"
                            max="30"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-700">Max Age: {ageRange[1]}</label>
                          <input
                            type="range"
                            min="18"
                            max="30"
                      ...
                      <h3 className="font-semibold text-gray-900 mt-4 mb-2">Experience</h3>
                      <div className="space-y-2">
                        {['Less than 1 year', '1-2 years', '3+ years'].map(exp => (
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8 flex justify-between items-center">
            <h2 className="text-2xl font-bold text-gray-900">Available Au Pairs</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {auPairs.map(auPair => (
              <div key={auPair.id} className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition">
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-bold text-gray-900">{auPair.name}</h3>
                  ...
                  <p className="text-gray-600 mb-4">{auPair.age} years old • {auPair.experience} experience</p>
                  ...
                  <p className="text-gray-600 text-sm mb-4 line-clamp-3">{auPair.bio}</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-xl text-gray-600">Hear from families who found their perfect au pair</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic mb-4">
                "We found our amazing au pair from Spain through AuPair Connect. She has been with us for over a year now and has become part of our family. Our children adore her!"
              </p>
              <div className="flex items-center">
                <img 
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic mb-4">
                "As a busy professional couple with twins, finding the right childcare was crucial. Our au pair from China has been a blessing - reliable, loving, and she's teaching our kids Mandarin!"
              </p>
              <div className="flex items-center">
                <img 
                  className="h-10 w-10 rounded-full object-cover mr-4"
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Host Family from Canada</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic mb-4">
                "The matching process was so thorough that we found the perfect au pair on our first try. She understands our family values and has brought so much joy and cultural exchange to our home."
              </p>
              <div className="flex items-center">
                <img 
                  className="h-10 w-10 rounded-full object-cover mr-4"
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Find Your Perfect Au Pair?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Create your family profile today and start connecting with qualified au pairs from around the world.
          </p>
