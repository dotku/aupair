...
import { Search, Filter, MapPin, Heart, MessageCircle, Star, ChevronDown, ChevronUp, Users, Home, DollarSign } from 'lucide-react';
  ...
  const families = [
    {
      ...
      description: 'We are a warm and active family looking for an au pair who enjoys outdoor activities and can help with our energetic children.',
    ...
    },
    {
      ...
      requirements: 'Experience with school-aged children, interest in arts and music',
      description: 'Our family values education and creativity. We\'re looking for an au pair who can help with homework and engage our child in enriching activities.',
      image: 'https://images.unsplash.com/photo-1581952976147-5a2d15560349?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80'
    },
    {
      id: 3,
      ...
      requirements: 'Experience with multiple children, patience, driver\'s license',
      description: 'We\'re a busy multicultural family looking for a responsible and energetic au pair who can handle the dynamics of three children of different ages.',
      image: 'https://images.unsplash.com/photo-1577368287217-16ff9373a733?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80'
    },
    {
      id: 4,
      ...
      description: 'We are looking for an au pair who can be a positive role model for our children and help them with their English while enjoying life in Paris.',
    ...
    },
    {
      ...
      requirements: 'Early childhood education experience preferred, interest in Japanese culture',
      description: 'We are seeking an au pair who is patient and creative to care for our daughter. We value cultural exchange and would love to share Japanese traditions while learning about yours.',
      image: 'https://images.unsplash.com/photo-1551995184-f34d2be3531c?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80'
    },
    {
      id: 6,
      ...
      description: 'Our family loves the beach, arts, and exploring the city. We\'re looking for an au pair who shares these interests and can bring fun learning experiences to our children.',
    ...
    <div>
      ...
      <section className="relative bg-blue-600 text-white">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: "url('https://images.unsplash.com/photo-1484723091739-30a097e8f929?ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80')",
            opacity: 0.2
          }}
        ></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Find Your Host Family</h1>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                      ...
                      <div className="space-y-2">
                        {['USA', 'Canada', 'Germany', 'France', 'Japan', 'Spain'].map(country => (
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Children's Ages</h3>
                      <div className="space-y-2">
                        {['Infants (0-1)', 'Toddlers (2-3)', 'Preschool (4-5)', 'School Age (6-12)', 'Teenagers (13+)'].map(age => (
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {['3-6 months', '6-9 months', '9-12 months', '12+ months'].map(dur => (
                      ...
                      <h3 className="font-semibold text-gray-900 mt-4 mb-2">Special Requirements</h3>
                      <div className="space-y-2">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {families.map(family => (
              <div key={family.id} className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <span className="text-gray-600">{family.duration}, starting {family.startDate}</span>
                    </div>
                    <div className="flex items-start">
                      <Globe className="h-5 w-5 text-gray-500 mr-2 mt-0.5" />
                      <span className="text-gray-600">{family.languages.join(', ')}</span>
                    </div>
                  </div>
                  
                  <div className="mb-4">
                    <h4 className="text-sm font-semibold text-gray-700 mb-1">Requirements</h4>
                    <p className="text-gray-600 text-sm">{family.requirements}</p>
                  </div>
                  
                  <p className="text-gray-600 text-sm mb-4 line-clamp-3">{family.description}</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Benefits of Being an Au Pair</h2>
            <p className="mt-4 text-xl text-gray-600">Why thousands of young adults choose the au pair experience</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">Experience a new culture firsthand by living with a local family and participating in their daily life.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">Enjoy the security of living with a vetted host family with private room and meals included.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">Receive a regular allowance to cover personal expenses while most of your basic needs are covered.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Au Pair Success Stories</h2>
            <p className="mt-4 text-xl text-gray-600">Hear from au pairs who found their perfect match</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic mb-4">
                "Being an au pair in the USA has been the best decision of my life. I've improved my English, made lifelong friends, and gained a second family who treats me like their own."
              </p>
              <div className="flex items-center">
                <img 
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic mb-4">
                "My host family in Germany has been incredibly supportive of my goals. They've helped me improve my German and even encouraged me to take university courses during my stay."
              </p>
              <div className="flex items-center">
                <img 
                  className="h-10 w-10 rounded-full object-cover mr-4"
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Au Pair from South Korea</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 italic mb-4">
                "I was nervous about living abroad, but AuPair Connect matched me with the perfect family in Canada. The children are wonderful, and I've had amazing opportunities to travel and explore."
              </p>
              <div className="flex items-center">
                <img 
                  className="h-10 w-10 rounded-full object-cover mr-4"
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Start Your Au Pair Adventure?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Create your au pair profile today and connect with families looking for someone just like you.
          </p>
